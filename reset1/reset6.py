...
# --- All your component classes are included here ---
...
class Prieze(Component):
    ...
    # CORRECTED: __init__ was not indented correctly in the original code
...
if __name__ == "__main__":
    ...
    canvas_width = (max_x + 1) * CELL_WIDTH + H_PADDING
    ...
    for node in all_nodes:
        ...
        x_pos = node.x * CELL_WIDTH + H_PADDING
